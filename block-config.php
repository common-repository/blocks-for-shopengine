	...
	private function block_list()
	{
		...
		$blocks_list =  [
			...
			'checkout-payment' => [
				...
				'icon'          => ' gutenova-Checkout-Payment',
				'server_render' => true,
			...
			'checkout-form-billing'	=> [
				...
				'icon'          => ' gutenova-checkout_order_pay',
				'server_render' => true,
				'category'      => 'shopengine-checkout',
				'keywords'      => [
			...
			'checkout-form-additional'	=> [
				...
				'icon'          => ' gutenova-checkout_form_additinal',
				'server_render' => true,
				'category'      => 'shopengine-checkout',
				'keywords'      => [
			...
			'filter-products-per-page'	=> [
				...
				'icon'          => ' gutenova-Products-Per-Page-Filter',
				'server_render' => true,
				'category'      => 'shopengine-archive',
				'keywords'      => [
			...
			'additional-information' => [
				...
				'icon'          => ' gutenova-Aditional-Information',
				'server_render' => true,
				'category'      => 'shopengine-single',
				'keywords'      => [
			...
			'product-categories' => [
				...
				'icon'          => ' gutenova-Product-Categories',
				'server_render' => true,
				'category'      => 'shopengine-single',
				'keywords'      => [
			...
			'archive-description'	=> [
				...
				'icon'          => ' gutenova-Archive-Description',
				'server_render' => true,
				'category'      => 'shopengine-archive',
				'keywords'      => [
			...
			'archive-result-count'	=> [
				...
				'icon'          => ' gutenova-Archive-Result-Count',
				'server_render' => true,
				'category'      => 'shopengine-archive',
				'keywords'      => [
			...
			'product-category-lists'	=> [
				...
				'icon'          => ' gutenova-Product-Category-List gutenova-font-size-16',
				'server_render' => true,
			...
			'recently-viewed-products'	=>  [
				...
				'icon'          => ' gutenova-Recently-View-Product gutenova-font-size-16',
				'server_render' => true,
				'category'      => 'shopengine-general',
				'keywords'      => [
			...
			'view-single-product'	=>  [
				...
				'icon'          => ' gutenova-Archive-Products',
				'server_render' => true,
				'category'      => 'shopengine-single',
				'keywords'      => [
			...
			'checkout-form-shipping'	=>  [
				...
				'icon'          => ' gutenova-checkout-form-shipping',
				'server_render' => true,
				'category'      => 'shopengine-checkout',
				'keywords'      => [
			...
			'checkout-review-order'	=>  [
				...
				'icon'          => ' gutenova-checkout_review_order',
				'server_render' => true,
				'category'      => 'shopengine-checkout',
				'keywords'      => [
			...
			'checkout-shipping-methods'	=>  [
				...
				'icon'          => ' gutenova-ck_shipping_methods',
				'server_render' => true,
				'category'      => 'shopengine-checkout',
				'keywords'      => [
			...
			'breadcrumbs'	=>  [
				...
				'icon'          => ' gutenova-Breadcrumb gutenova-font-size-16 gutenova-margin-left--10',
				'server_render' => true,
				'category'      => 'shopengine-single',
				'keywords'      => [
			...
			'checkout-coupon-form'	=>  [
				...
				'icon'          => ' gutenova-checkout_coupon_form',
				'server_render' => true,
				'category'      => 'shopengine-checkout',
				'keywords'      => [
			...
			'filterable-product-list'	=>  [
				...
				'icon'          => ' gutenova-Filterable-Product-List gutenova-font-size-16',
				'server_render' => true,
				'category'      => 'shopengine-general',
				'keywords'      => [
			...
			'related'	=>  [
				...
				'icon'          => ' gutenova-Related-Products',
				'server_render' => true,
				'category'      => 'shopengine-single',
				'keywords'      => [
			...
			'product-description'	=>  [
				...
				'icon'          => ' gutenova-product_description',
				'server_render' => true,
				'category'      => 'shopengine-single',
				'keywords'      => [
			...
			'heading' => [
				...
				'icon'          => ' gutenova-Heading gutenova-font-size-16',
				'server_render' => true,
				'category'      => 'shopengine-general',
				'keywords'      => [
			...
			'checkout-form-login' => [
				...
				'icon'          => ' gutenova-checkout_form_login',
				'server_render' => true,
				'category'      => 'shopengine-checkout',
				'keywords'      => [
			...
			'archive-view-mode'	=>  [
				...
				'icon'          => ' gutenova-Archive-View-Mode',
				'server_render' => true,
				'category'      => 'shopengine-archive',
				'keywords'      => [
		...
		if (class_exists('ShopEngine_Pro')) {
			...
			$blocks_list_pro = [
				'thankyou-thankyou'	=>  [
					...
					'icon'          => ' gutenova-thank_you_message',
					'server_render' => true,
				...
				'thankyou-order-confirm'	=>  [
					...
					'icon'          => ' gutenova-thank_you_order_details-1',
					'server_render' => true,
					'category'      => 'shopengine-order',
					'keywords'      => [
				...
				'thankyou-order-details'	=>  [
					...
					'icon'          => ' gutenova-thank_you_order_details',
					'server_render' => true,
					'category'      => 'shopengine-order',
					'keywords'      => [
				...
				'thankyou-address-details'	=>  [
					...
					'icon'          => ' gutenova-thank_you_address_details',
					'server_render' => true,
					'category'      => 'shopengine-order',
					'keywords'      => [
				...
				'account-form-register'	=>  [
					...
					'icon'          => ' gutenova-account_register_form',
					'server_render' => true,
					'category'      => 'shopengine-my-account',
					'keywords'      => [
				...
				'account-downloads'	=>  [
					...
					'icon'          => ' gutenova-account_download',
					'server_render' => true,
					'category'      => 'shopengine-my-account',
					'keywords'      => [
				...
				'account-dashboard'	=>  [
					...
					'icon'          => ' gutenova-account_dashboard',
					'server_render' => true,
					'category'      => 'shopengine-my-account',
					'keywords'      => [
				...
				'currency-switcher' => [
					...
					'icon'          => ' gutenova-Currency-Switcher',
					'server_render' => true,
					'category'      => 'shopengine-general',
					'keywords'      => [
				...
				'best-selling-product' => [
					...
					'icon'          => ' gutenova-Best-Selling-Product',
					'server_render' => true,
					'category'      => 'shopengine-general',
					'keywords'      => [
				...
				'comparison-button' => [
					...
					'icon'          => ' gutenova-Comparison-Button',
					'server_render' => true,
					'category'      => 'shopengine-general',
					'keywords'      => [
				...
				'account-navigation' => [
					...
					'icon'          => ' gutenova-account_navigation',
					'server_render' => true,
					'category'      => 'shopengine-my-account',
					'keywords'      => [
				...
				'advanced-coupon' => [
					...
					'icon'          => ' gutenova-Advance-Coupon gutenova-font-size-16',
					'server_render' => true,
					'category'      => 'shopengine-general',
					'keywords'      => [
				...
				'vacation' => [
					...
					'icon'          => ' gutenova-Vacation-Notice gutenova-font-size-16',
					'server_render' => true,
					'category'      => 'shopengine-general',
					'keywords'      => [
				...
				'product-size-charts' => [
					...
					'icon'          => ' gutenova-Product-Size-Chart',
					'server_render' => true,
					'category'      => 'shopengine-single',
					'keywords'      => [
				...
				'checkout-order-pay' => [
					...
					'icon'          => ' gutenova-Checkout-Order-Pay',
					'server_render' => true,
					'category'      => 'shopengine-checkout',
					'keywords'      => [
